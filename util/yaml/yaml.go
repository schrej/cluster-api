...
func ExtractClusterReferences(out *ParseOutput, c *clusterv1.Cluster) (res []*unstructured.Unstructured) {
	...
	if obj := out.FindUnstructuredReference(c.Spec.InfrastructureRef.FullRef(c.Namespace)); obj != nil {
		res = append(res, obj)
	}
	return
}
...
func ExtractMachineReferences(out *ParseOutput, m *clusterv1.Machine) (res []*unstructured.Unstructured) {
	if obj := out.FindUnstructuredReference(m.Spec.InfrastructureRef.FullRef(m.Namespace)); obj != nil {
		res = append(res, obj)
	}
	if m.Spec.Bootstrap.ConfigRef != nil {
		if obj := out.FindUnstructuredReference(m.Spec.Bootstrap.ConfigRef.FullRef(m.Namespace)); obj != nil {
			res = append(res, obj)
		}
	}
	return
