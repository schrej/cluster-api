...
func (r *Ref) Get(obj *unstructured.Unstructured) (*clusterv1.ObjectReference, error) {
...
func GetNestedRef(obj *unstructured.Unstructured, fields ...string) (*clusterv1.ObjectReference, error) {
